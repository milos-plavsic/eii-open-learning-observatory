...
| Learner surveillance | Raw fields are rejected, day/cell-scoped pseudonyms prevent cross-cell linkage, k-thresholds suppress cells, retention purges events. | Thresholding is not differential privacy; operators could violate policy outside this software. |
